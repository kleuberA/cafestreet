        ...
        <section className="w-full min-h-screen">
            ...
            <div className="z-10 relative">
                ...
                <div className="w-[80dvw] mx-auto h-[70dvh] flex flex-col lg:flex-row items-center pt-10 lg:pt-0">
                    <div className="flex flex-col gap-3 h-72 lg:h-full justify-center lg:flex-1">
                        <h1 className="text-xl lg:text-6xl font-bold lg:w-[45dvw] text-[#2F2105]">Enjoy your <span className='text-[#FF902B]'>coffee</span> before your activity</h1>
